...
class GBDriversTestCase(unittest.TestCase, BaseTestCase):
    ...
    def test_gbdrivers_1(self):
        ...
        AFTER:  The driving licence number of the claimant is {{GBDRIVERS}}, and a copy of the licence is attached.
        """
    ...
    def test_gbdrivers_2(self):
        ...
        AFTER:  My DVLA NO is {{GBDRIVERS}} could you please check.
        """
        self.compare_before_after()
