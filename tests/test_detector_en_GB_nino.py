...
class GBNinoTestCase(unittest.TestCase, BaseTestCase):
    ...
    def test_nino_2(self):
        ...
        AFTER:  Enter a National Insurance number that is 2 letters, 6 numbers, then A, B, C or D, like {{NINO}}.
        """
        self.compare_before_after(locale='en_GB')
    ...
    def test_nino_3(self):
        ...
        AFTER:  It’s on your National Insurance card, benefit letter, payslip or P60. For example, {{NINO}}.
        """
        self.compare_before_after(locale='en_GB')
    ...
    def test_nino_4(self):
        ...
        AFTER:  Please verify the NI {{NINO}}.
        """
        self.compare_before_after(locale='en_GB')
