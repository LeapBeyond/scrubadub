"""scrubadub currently removes persaonlly identifiable information with some
...
# person_identifies_filth might be a web interface that identifies different
# pieces of filth.
...
for document in training_documents:
    ...
    # -i` might be a decent example). I imagine doing this in a web interface
    # where users can easily brush text to improve recall and adjust the
    # preliminary filth_list to improve precision
    filth_list = person_identifies_filth(document, filth_list)

    # The TrianedScrubber.train method should incorporate the filth_list into
