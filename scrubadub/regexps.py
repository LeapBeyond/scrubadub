...
# sure all valid skype usernames are considered the same token. Importantly, the
# word "skype" must pass the _SKYPE regex. SKYPE_TOKEN is used to tokenize text
# and SKYPE_USERNAME is the same thing but with the 6-32 character limit imposed
# on the username. adapted from
